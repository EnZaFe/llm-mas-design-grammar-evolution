...
This directory contains the datasets and experimental data used in the study described in the companion paper.
...
Each subdirectory includes its own description or metadata file. Data files are provided in standard formats (CSV, JSON, or plain text) to maximise reproducibility and interoperability.
